...
const bjstorageRouter = {
    ...
    children: [
      {
        path: 'goods-manager',
        component: () => import('@/views/wms/storage/goods/bjitemmanager'),
        name: 'BJGoodsManager',
        meta: { title: '商品管理', noCache: true, roles:[]},
      },
      {
        path: 'goodsdetial-manager/:id',
        component: () => import('@/views/wms/storage/goods/bjitemdetailmanager'),
        name: 'BJGoodsDetialInfo',
        hidden:true,
        meta: { title: '货物管理', noCache: true, roles:[]},
      },
      {
        path: 'goodsdetialprop-manager/:id',
        component: () => import('@/views/wms/storage/goods/bjitemdetailpropmanager'),
        name: 'BJGoodsDetialPropInfo',
        hidden:true,
        meta: { title: '货物参数管理', noCache: true, roles:[]},
      },
      {
        path: 'goodslist-manager',
        component: () => import('@/views/wms/storage/stock/bjgoodsList'),
        name: 'BJGoodsListManager',
  ...
  export default bjstorageRouter